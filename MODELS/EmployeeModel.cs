...
namespace MODELS
{
    ...
    public class EMERG_TYPE_SELECT
    {
        ...
        public List<UPLOAD_DOCUMENT> Photos_List { get; set; }
    }
    ...
    //}
    public class UPLOAD_DOCUMENT_FILE
    {
        public List<UPLOAD_DOCUMENT> EMERG_TYPE_DOC { get; set; }

    }
    public class RETURN_MESSAGE_UNIQUEID
    {
        public string STATUS_CODE { get; set; }
        public bool STATUS { get; set; }
        public string MESSAGE { get; set; }
    ...
    public class RETURN_MESSAGE_INSP_PHOTO
    {
        public string STATUS_CODE { get; set; }
        public bool STATUS { get; set; }
        public string MESSAGE { get; set; }
    ...
    public class GET_EMPLOYEE_PERSION_DETAILS
    {
        public string EMPLOYEE_ID { get; set; }
        public string EMPLOYEE_NAME { get; set; }
        public string STATUS { get; set; }
    ...
    public class GET_COVID_TEST_RESULT_LIST
    {
        public string EMP_ID { get; set; }
        public string NO_OF_DAYS { get; set; }
        public List<GET_COVID_TEST_RESULT_EMP> COVID_TEST_RESULT_EMPLOYEE { get; set; }
        public List<EMP_DOSE_DETAILS> VACCINE_DETAILS { get; set; }
    }
    public class GET_COVID_TEST_RESULT_EMP
    {
        public string EMP_ID { get; set; }
        public string EMP_FIRSTNAME { get; set; }
        public string EMP_NAME_AR { get; set; }
        ...
        public string EMP_EMAIL { get; set; }
        public string EMP_LOCATION_ID { get; set; }
        public string EMP_LOCATION_EN { get; set; }
        public string EMP_LOCATION_AR { get; set; }
        public string EMP_BUILDING_ID { get; set; }
        public string EMP_BUILDING_EN { get; set; }
        public string EMP_BUILDING_AR { get; set; }
        public string EMP_SECTOR_ID { get; set; }
        public string EMP_SECTOR_EN { get; set; }
        public string EMP_SECTOR_AR { get; set; }
        public string EMP_DEPARTMENT_ID { get; set; }
        public string EMP_DEPARTMENT_EN { get; set; }
        public string EMP_DEPARTMENT_AR { get; set; }
        public string EMP_SECTION_ID { get; set; }
        public string EMP_SECTION_EN { get; set; }
        public string EMP_SECTION_ID_AR { get; set; }
        public string UNIQUE_ID { get; set; }
    }

    public class GET_ALL_COVID_TEST_RESULT_LIST
    {
        public string UNIQUE_ID { get; set; }
        public string CASE_ID { get; set; }
        public string IS_CHECK_NEG_POS { get; set; }
    ...
    public class GET_REPORTING_COVID_CASE_LIST
    {
        public string UNIQUE_ID { get; set; }
        public string CASE_ID { get; set; }
        public string IS_CHECK_NEG_POS { get; set; }
    ...
    public class ADD_REPORTING_COVID_CASE
    {
        public string CASE_ID { get; set; }
        public string EMP_ID { get; set; }
        public string CASE_TYPE { get; set; }
        ...
        public List<ADD_COVID_REPORT_COVID_CASE_OUTSIDE> _OUTSIDE_OFFICE_PERSION_LIST { get; set; }
